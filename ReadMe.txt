...
# Scrambled Words
Count how many of the words from a dictionary appear as substrings in a long string of characters 
either in their original form or in their scrambled form. 
The scrambled form of the dictionary word must adhere to the following rule: 
...
Step 5: Create the executable using Pyinstaller
	...
	* An executable should be created at your desktop loc
